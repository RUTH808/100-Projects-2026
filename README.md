...
5) Qrscanner2 is upgraded version of the previous QR scanner/decoder. Now it has a dashboard which displays crucial information along with the QR its decoding and stores in a csv.
